-- ========================================
-- ✅ SQL SEGURO - PODE EXECUTAR MÚLTIPLAS VEZES
-- ========================================
-- Este arquivo usa DROP IF EXISTS para evitar erros
...
DROP VIEW IF EXISTS wallet_statistics;
...
SELECT 
  ...
  END as operacao
FROM pg_policies
WHERE tablename IN ('wallet_transactions', 'webhook_logs')
...
-- 4. View de estatísticas disponível
-- ========================================

SELECT '✅ Sistema PIX completo instalado com sucesso!' as status;
