-- ========================================
-- TABELAS AUXILIARES PARA SISTEMA PIX COMPLETO
-- ========================================
-- Execute este script no Supabase SQL Editor
-- ========================================

-- 1. Tabela de transações de carteira (wallet_transactions)
-- Registra todas as movimentações de saldo
CREATE TABLE IF NOT EXISTS wallet_transactions (
  ...
  -- Tipo de transação
  transaction_type VARCHAR(20) NOT NULL, -- 'credit', 'debit', 'lock', 'unlock'
  ...
  reference_id UUID, -- ID da transação original (pix_transaction, withdrawal, etc)
  reference_type VARCHAR(50), -- 'pix_transaction', 'withdrawal', 'transfer', etc
...
-- ========================================
-- 3. Função para limpar logs antigos (manutenção)
-- ========================================
...
-- ========================================
-- 4. Trigger para atualizar updated_at em wallets
-- ========================================
...
-- ========================================
-- 5. View para estatísticas de carteiras
-- ========================================
...
-- ========================================
-- 6. Função para verificar saldo disponível
-- ========================================
...
-- 3. Teste o sistema de crédito automático
-- 4. Configure webhooks nos adquirentes
-- ========================================
